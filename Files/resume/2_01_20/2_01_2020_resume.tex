...
\begin{rSubsection}{Freddie Mac, McLean}{May 2019-August 2019}{Financial Engineering Intern}{} 
    ...
    \item Developed data visualizations (Heatmaps, Bar charts) using Python libraries Bokeh and Pandas from data generated through feature engineering. 
    \item Developed a Django web application that generate visuals based on incoming and allowed for customizable axises for said visuals. Used by Engineers to help analyze housing data.
\end{rSubsection}

\begin{rSubsection}{Audience1st}{January 2019-May 2019}{Software Developer}{}
    \item Part of an academic project where groups of students are assigned to small businesses or startups to work on some of their features of their web application. Involved many Software Engineer practices, 
    such as continuous integration and user stories. Most of the projects were done in Rails.
...
\item Developed content for the SQLite lecture, which included a Jupyter Notebook lab, a Gradescope autograder environment, and a Introduction to Databases presentation, which covered basic SQL queries and Pandas interactions.
\end{rSubsection}
