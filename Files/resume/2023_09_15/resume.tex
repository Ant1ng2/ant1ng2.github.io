...
\begin{rSubsection}{Amazon, Seattle}{August 2021-}{Software Development Engineer}{} 
    ...
    \item Designed and developed an Error handling mechanism using CloudFormation and Lambda to redrive failed requests from DynamoDB to Postgres for database synchronization.
    \item Designed and developed an automation tool tool to fetch availability dips from metrics, fetch related logs, and generate reports using PCA.
