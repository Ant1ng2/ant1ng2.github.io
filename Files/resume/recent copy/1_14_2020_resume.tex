...
\begin{rSubsection}{Freddie Mac, McLean}{May 2019-August 2019}{Financial Engineering Intern}{} 
    ...
    \item Developed data visualizations (Heatmaps, Bar charts) using Python libraries Bokeh and Pandas. 
    \item Developed a Django web application that generate visuals and allowed for customizable axises for said visuals.
\end{rSubsection}
...
\begin{rSubsection}{GamesCrafters}{2018-2020}{Research and Project Development}{}
    ...
    \item Helped implement the Universal Web API to combine game solutions from multiple backends. Specifically, worked on translating chess solutions from the Syzygy endgame tablebases from its public API.
    \item Researched ways of using Decision Trees as a way to reduce key-value pairs into a series of feature decisions (i.e. number of pieces on the board, whether the second piece is an "X" or an "O").
\end{rSubsection}
