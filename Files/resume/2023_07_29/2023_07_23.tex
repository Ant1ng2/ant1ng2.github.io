...
\address{1-925-325-7144 \\ ant1ng@berkeley.edu \\ https://ant1ng2.github.io \\ Pleasanton, CA} 
...
\begin{rSubsection}{Amazon, Seattle}{August 2021-}{Software Development Engineer}{} 
    \item Worked as a Backend engineer for the Campaign Management Platform for Amazon Advertising (Performance Advertising). Expert-level experience with AWS services (DynamoDB, Cloudwatch, SWF, CloudFormation).
    \item Worked on deprecation efforts of legacy and migration of Campaign Management backends. Collaborated with multiple clients and stakeholders to deprecate their calls.
    \item Developed a script to generate reports and investigate availability dips with automation to improve oncall productivity (i.e. API calls to GitLab to automatically publish logs)
    \item Experience with Amazon oncall and software development process, such as pipeline deployments, code reviews, Agile workflow, approval workflows. 
\end{rSubsection}
